...
require $DR.'/classes/MailClass.php';
...
if($_POST[username] !='' && $_POST[email] !='' && $_POST[handle_ja] !='' && $_POST[password] !=''){
    ...
    echo __LINE__."<br />";
            ...
            $MailClass->sjis_mail($_POST['email'],PRE_ENTRY_SUBJECT_J,$body);
            
            
            exit;
 //           echo "email=".$this->request->data['email']; 
echo __LINE__."<br />";
$res =            mailsend($_POST['email'],PRE_ENTRY_SUBJECT_J,$body,SENDER_J,NO_REPLAY_MAIL);
echo __LINE__."<br />";
var_dump($res);            
