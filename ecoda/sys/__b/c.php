...
<span id="third_category">88888888888888888</span>
  <span id="catgory_title" ></span>
  <input type="hidden1" name="category_id" id="category_id" value="" />
...
function setDataThird(jsons){
  ...
  $.each(jsons, function(index,json) {
    ...
    tags_third += "<span class='ct3'><input type='checkbox' onclick='alert("+id+")' name='sub_root_category_id"+id+"' value='"+id+"' />"+title+"</span>&nbsp;";
