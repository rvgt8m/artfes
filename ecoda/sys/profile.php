...
<link rel="stylesheet" media="all" href="/_css/profile_style.css">
...
<header id="header">
	<img src="/images/pre/mainImg.jpg" alt="">
	<div id="slogan">
		<h1>Vestibulum mauris</h1>
		<h2>最新技術と自然との調和を目指す</h2>
	</div>
</header>
...
<section id="sec02">
	<div class="wrap">
		<p class="bg"><img src="/images/pre/sec02_01.jpg" alt=""></p>
		<div class="txt">
			<div class="vMid" style="height: 355px; padding: 50px 20px;">
				<h2>MESSAGE</h2>
	...
	<div id="sec02_02" class="wrap">
		<p class="bg"><img src="/images/pre/sec02_02.jpg" alt=""></p>
		<div class="txt">
			<div class="vMid" style="height: 355px; padding: 50px 20px;">
				<h2>MESSAGE</h2>
...
<section id="sec03">
	<div class="inner">
		<ul class="col3">
			<li>
				<h2>SERVICE</h2>
				<img src="/images/pre/circleImg01.png" width="288" height="288" alt="">
				<p>科学的研究というのが近代史学の学問的方法による研究という意義であるならば、これは史学の学徒の間においては一般に行われていることであるから、今さらこと新しくいう。</p>
			</li>
			<li>
				<h2>MESSAGE</h2>
				<img src="/images/pre/circleImg02.png" width="288" height="288" alt="">
				<p>日本歴史の科学的研究ということがしきりに叫ばれている。科学的研究というのが近代史学の学問的方法による研究という意義であるならば意義であるならば。</p>
			</li>
			<li>
				<h2>STORY</h2>
				<img src="/images/pre/circleImg03.png" width="288" height="288" alt="">
				<p>科学的研究というのが近代史学の学問的方法による研究という意義であるならば、これは史学の学徒の間においては一般に行われていることであるから、今さらこと新しくいう。</p>
			</li>
		</ul>
	</div>
	...
	<div class="inner">
		<ul class="col2">
			...
			<li>
				<div id="map">
					<!-- GOOGLE MAP -->
					<iframe src="./_css/embed.html" allowfullscreen=""></iframe>
					<!-- // GOOGLE MAP -->
				</div>
			</li>
		</ul>
...
<footer id="footer">
	Copyright(c) 20XX Sample Inc. All Rights Reserved. Design by <a href="http://f-tpl.com/" target="_blank">http://f-tpl.com</a>
</footer>
